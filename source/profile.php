            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="mailto:maitri02manu@gmail.com" target="_blank" class="btn btn-sm btn-primary">Request Change</a>
                </div>
              </div>
            </div>
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col" style="font-size: 13px;"><?= $student['rollnumber']; ?></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <th scope="row">Hostel</th>
                    <td><?= strtoupper($student['hostel']); ?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><?= strtoupper($student['roomnumber']); ?></td>
                  </tr>
                </tbody>
              </table>
            </div>
