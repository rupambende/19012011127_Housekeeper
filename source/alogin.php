            ...
            <form action="" method="POST" autocomplete="off" class="col s12">
              ...
              <div class="row flex-h-center mb-0">
                <div class="input-field col s8">
                  <input type="text" name="adminUsername" id="username" class="validate" required>
              ...
              <button type="submit" name="adminLogin" class="waves-effect waves-light btn">Sign IN</button>
            </form>
            <a class="link" href="login.php">or Student login</a><br>
            <a class="link" href="fg_pass.php">Forgot Password</a>
          </div>
        </div>
      </div>
    </div>
